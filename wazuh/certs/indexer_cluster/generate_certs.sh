...
openssl req -new -key admin-key.pem -out admin.csr -subj "/C=US/L=California/O=Company/CN=admin"
...
openssl req -new -key node-key.pem -out node.csr -subj "/C=US/L=California/O=Company/CN=indexer"
...
openssl req -new -key dashboard-key.pem -out dashboard.csr -subj "/C=US/L=California/O=Company/CN=dashboard"
...
openssl req -new -key filebeat-key.pem -out filebeat.csr -subj "/C=US/L=California/O=Company/CN=filebeat"
